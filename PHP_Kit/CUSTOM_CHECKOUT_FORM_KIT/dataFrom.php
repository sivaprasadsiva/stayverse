...
if ($con) {
	...
	$sql    = "SELECT total_price FROM booking WHERE id =".$order_id;
	...
	}else if(!empty($_GET['booking_plan'])){

	$order_id = $_GET['booking_plan'];

	$sql    = "SELECT plan_price FROM plan_booking WHERE id =".$order_id;
	$result = mysqli_query($con, $sql);
	$row    = mysqli_fetch_assoc($result);
	...
	<form method="POST" name="customerData" action="ccavRequestHandler.php">
		<table width="40%" height="100" border='1' align="center"><caption><font size="4" color="blue"><b>Integration Kit</b></font></caption></table>
			<table width="50%" height="100" border='1' align="center">
				...
				<tr>
					<td>Merchant Id	:</td><td><input type="text" name="merchant_id" value="2786817"/></td>
				</tr>
				<tr>
					<td>Order Id	:</td><td><input type="text" name="order_id" value="<?= $order_id;?>"/></td>
				</tr>
				<tr>
					<td>Amount	:</td><td><input type="text" name="amount" value="<?= $price;?>"/></td>
				</tr>
				<tr>
				...
				<!--	<td>Redirect URL	:</td><td>-->
					    <input type="hidden" name="redirect_url" value="http://stayverse.in/PHP_Kit/CUSTOM_CHECKOUT_FORM_KIT/ccavResponseHandler.php"/>
				<!--	    </td>-->
				<!--</tr>-->
			 <!--	<tr>-->
			 <!--		<td>Cancel URL	:</td><td>-->
			 		    <input type="hidden" name="cancel_url" value="http://stayverse.in/PHP_Kit/CUSTOM_CHECKOUT_FORM_KIT/ccavResponseHandler.php"/>
			 	<!--	    </td>-->
			 	<!--</tr>-->
			 	<tr>
		 ...
		 <!--    	</tr>-->
		 <!--       <tr>-->
		 <!--       	<td>Billing Name	:</td><td><input type="text" name="billing_name" /></td>-->
		 <!--       </tr>-->
		 <!--       <tr>-->
		 <!--       	<td>Billing Address	:</td><td><input type="text" name="billing_address" /></td>-->
		 <!--       </tr>-->
		 <!--       <tr>-->
		 <!--       	<td>Billing City	:</td><td><input type="text" name="billing_city" /></td>-->
		 <!--       </tr>-->
		 <!--       <tr>-->
		 <!--       	<td>Billing State	:</td><td><input type="text" name="billing_state" /></td>-->
		 <!--       </tr>-->
		 <!--       <tr>-->
		 ...
		 <!--       </tr>-->
		 <!--       <tr>-->
		 <!--       	<td>Billing Email	:</td><td><input type="text" name="billing_email" /></td>-->
		 <!--       </tr>-->
		 <!--       <tr>-->
		 <!--       	<td colspan="2">Shipping information(optional)</td>-->
		 <!--       </tr>-->
		 <!--       <tr>-->
		 <!--       	<td>Shipping Name	:</td><td><input type="text" name="delivery_name" /></td>-->
		 <!--       </tr>-->
		 <!--       <tr>-->
		 <!--       	<td>Shipping Address	:</td><td><input type="text" name="delivery_address" /></td>-->
		 <!--       </tr>-->
		 <!--       <tr>-->
		 <!--       	<td>shipping City	:</td><td><input type="text" name="delivery_city" /></td>-->
		 <!--       </tr>-->
		 <!--       <tr>-->
		 <!--       	<td>shipping State	:</td><td><input type="text" name="delivery_state" /></td>-->
		 <!--       </tr>-->
		 <!--       <tr>-->
		 ...
		 <!--       </tr>-->
		 <!--       <tr>-->
		 <!--       	<td>Shipping Tel	:</td><td><input type="text" name="delivery_tel" /></td>-->
		 <!--       </tr>-->
		        <!--<tr>-->
		        <!--	<td>Merchant Param1	:</td><td>-->
		        	    <input type="hidden" name="merchant_param1" value="<?= $page?>"/>
		        <!--	    </td>-->
		        <!--</tr>-->
		 <!--       <tr>-->
		 <!--       	<td>Merchant Param2	:</td><td><input type="text" name="merchant_param2" /></td>-->
		 <!--       </tr>-->
			<!--	<tr>-->
			<!--		<td>Merchant Param3	:</td><td><input type="text" name="merchant_param3" /></td>-->
			<!--	</tr>-->
			<!--	<tr>-->
			<!--		<td>Merchant Param4	:</td><td><input type="text" name="merchant_param4" /></td>-->
			<!--	</tr>-->
			<!--	<tr>-->
			<!--		<td>Merchant Param5	:</td><td><input type="text" name="merchant_param5" /></td>-->
			<!--	</tr>-->
			<!--	 <tr>-->
		 ...
		 <!--        </tr>-->
		        ...
		        <tr>
		        	<td></td><td><INPUT TYPE="submit" id="clickButton" value="CheckOut"></td>
		        </tr>
	      	</table>
	      </form>
</body>
