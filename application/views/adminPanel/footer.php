...
<script >
    ...
    $('#data').on('click','.approve_btn',function(){
    	var id = $(this).data('id');
                $.ajax({
                url:"<?= base_url()?>dashboard_admin/approve_owner",
                method:"POST",
                data:{id:id},
                success:function(response){

                	$('.dismiss_btn').hide();
                	$(this).replaceWith("<a class='btn' style='background-color: red;color:white;'>Approved</a>");
    ...
    $('#data').on('click','.dismiss_btn',function(){
    	var id = $(this).data('id');
                $.ajax({
                url:"<?= base_url()?>dashboard_admin/dismiss_owner",
                method:"POST",
                data:{id:id},
                success:function(response){

                	$('.approve_btn').hide();
                	$(this).replaceWith("<a class='btn' style='background-color: green;color:white;'>Dismissed</a>");
