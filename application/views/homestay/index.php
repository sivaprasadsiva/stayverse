...
<head>
	...
	<!-- PAGE TITLE HERE -->
	<title>Stayvers Homestay | LOGIN </title>
								...
								<div class="sign-in-your">
									...
									<div class="text-center my-5">
										<a href=""><img width="200"
												src="<?= base_url();?>assets1/images/logo.png" alt=""></a>
									</div>
									...
									<br><br>
									<?= form_open((base_url().'loginPage_homestay'), array('id' => 'loginForm')) ?>
									<div class="mb-3">
										<label class="mb-1"><strong>Email</strong></label>
										<input type="email" name="uname" class="form-control" value="">
									</div>
									<div class="mb-3">
