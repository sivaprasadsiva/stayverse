                    ...
                    <table class="table table-striped" id="example4">
                        ...
                        <tbody id="data">
                            ...
                            foreach ($rooms as $row): ?>
                                ...
                                <td>
                                    <a href="<?= base_url().'homestay/update_rooms/'.$row['rid']?>" class="btn btn-danger "><i class="fa fa-pencil"></i></a>
            ...
            <div class="modal-dialog">
                ...
                <div class="form-control">
                    ...
                    <div class="modal-body">        
                            <?php echo form_open_multipart(base_url().'homestay/rooms')?>
                            ...
                            <input type="text" class="form-control mt-2" placeholder="Room No" name="no" required>
