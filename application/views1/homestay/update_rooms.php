    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-6 offset-3">
                <?php echo form_open_multipart(base_url().'homestay/update_rooms/'.$id)?>
                <img src="<?= $img?>" width="130px" height="100px"> <a href="<?= base_url().'homestay/update_rooms_img/'.$id?>" class="btn btn-danger">change</a><br>
                            ...
                            <label>Details</label>
                            <textarea class="form-control" name="details" rows="5" placeholder="Details"><?= $details?></textarea>
