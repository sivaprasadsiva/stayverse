                    ...
                    <div class="row">
                        <div class="col-sm-12">  
                            <div class="form-group">
                              ...
                              <input type="text" name="guests" id="guests" class="form-control" placeholder="Number of Guests" value="<?php if(!empty($this->session->flashdata('guests')))echo $this->session->flashdata('guests');?>" required>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-6">  
                            <div class="form-group">
                              ...
                              <input type="date" name="checkin" id="checkin" class="form-control onlydatepicker" value="<?php if(!empty($this->session->flashdata('checkin'))){echo $this->session->flashdata('checkin');}else{ date('Y-m-d');}?>" required>
                             </div>
                        </div>
                        <div class="col-sm-6">  
                            <div class="form-group">
