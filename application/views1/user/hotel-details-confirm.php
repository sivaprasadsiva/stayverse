               ...
               <div class="skyp__hotels__wrap mb__40">
                  <div class="d-flex thumb__content gap-4 align-items-center">
                     <div class="left__thumb gap-2 d-flex align-items-center">
                        ...
                        <img src="<?= base_url().'assets/images/'.$g['image_gallery']?>" class="w-100" alt="img" width="100px" height="100px">
                     <?php }}?>
                     </div>
            ...
            <div class="hotel__confirm__invocie">
               ...
               <ul class="price__cost mb__30">
                  <li class="d-flex align-items-center justify-content-between">
                     ...
                     <span class="fz-18 fw-400 lato dtext">
                        <?php $price = 0; if(!empty($rooms_session)){ 
                           foreach($rooms_session as $rs){
                              foreach($rooms as $r){
                  ...
                  <?php if($code == 0){?>
                  <li class="d-flex align-items-center justify-content-between" id="price" value="<?= $price?>">
                     <span class="fz-18 fw-400 lato dtext">
                        Total cost
                     </span>
                     <span class="fz-18 fw-400 lato dtext">
                  ...
                  <?php }elseif($code == 1){?>
                      <li class="d-flex align-items-center justify-content-between" id="price" value="<?= round($price-($price*($percentage/100)))?>">
                     <span class="fz-18 fw-400 lato dtext">
                        Total cost
                     </span>
                     <span class="fz-18 fw-400 lato dtext">
                        ₹ <?php echo number_format($price-($price*($percentage/100))) ;?>
                     </span>
                  </li>
                  <?php }?>
               </ul>
               <?php if($code == 0){?>
               <?php echo form_open((base_url().'userpanel/coupon/'.$id),array('class'=>'d-flex mb__30 align-items-center justify-content-between')) ?>
               ...
               <div class="direct__transfer">
                  <div class="type__radio mb__10 d-flex align-items-center justify-content-between">
                     <div class="radio__left d-flex align-items-center gap-2">
                        <input class="" type="radio" name="payment" value="Direct">
                  ...
                  <!-- <div class="type__radio mb__10 d-flex align-items-center justify-content-between">
                     <div class="radio__left d-flex align-items-center gap-2">
                        <input class="" type="radio" name="payment" value="Check">
                  ...
                  <div class="type__radio mb__10 d-flex align-items-center justify-content-between">
                     <div class="radio__left d-flex align-items-center gap-2">
                        <input class="" type="radio" name="payment" value="PayPal">
                  ...
                  <p id="payment" style="color:red;font-size: 12px;display: none;">Select payment mode.</p>
               </div>
               <div class="have__condition mt__30 mb__30">
                  <div class="radio__left d-flex align-items-center gap-2">
                     <input class="form-check-input" type="checkbox" name="payment_terms">
                  ...
                  <p id="terms" style="color:red;font-size: 12px;display: none;">Accept terms and conditions.</p>
               </div>
               <div class="payment text-center mb__30">
                  <a  class="cmn__btn paymentnow" data-id="<?= $id?>">
                     <span>
                        Payment Now
                     </span>
                  </a>
