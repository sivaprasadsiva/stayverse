      ...
      <div class="row align-items-center justify-content-between">
         <div class="col-xl-6 col-lg-6">
            <div class="signup__boxes">
               ...
               <?php if($page == 2){ echo form_open((base_url().'userpanel/login_vehicle_booking/'.$vehicle_id.'/'.$sep),array('class'=>'signup__form'));}else{
                  echo form_open((base_url().'userpanel/login_confirm_booking'),array('class'=>'signup__form'));
               }?>
                  <div class="row g-4">
                     <div class="col-lg-12">
                     ...
                     <a href="<?= base_url().'userpanel/forgotten_password/'.$page.'/'.$vehicle_id.'/'.$sep?>" class="forgot">
                        Forgot Password?
                     </a>
               ...
               <?= form_close()?>
               <p>Don't you have an account click to <a href="<?= base_url().'userpanel/otp1/'.$page.'/'.$vehicle_id.'/'.$sep?>" style="color: blue;">Sign up</a> here.</p>
            </div>
